...
const footerData = {
  ...
  logoSrc: "https://c.animaapp.com/U7V4C1eZ/img/coldwhite-8@2x.png",
  logoAlt: "Cold white",
};
...
export const MainFooterSection = (): JSX.Element => {
  return (
    ...
    >
      ...
      <div className="flex-col max-w-screen-xl items-start gap-12 w-full flex-[0_0_auto] flex px-8 py-0 relative">
        <nav
